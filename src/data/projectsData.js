...
for epoch_i in range(epochs):
    ...
    },
    {
      ...
      fullContent: (
        <div>
         <section>
          <img src="https://sds-platform-private.s3-us-east-2.amazonaws.com/uploads/74_blog_image_1.png" alt="DNN" className="w-6/12" />
          <h3 className="font-semibold mt-4">Premise</h3>
              <ul className="list-disc ml-6">
                  <li>First ever ML project: Wanted to learn the basics of Machine Learning and CV. </li>
                </ul>
              <h3 className="font-semibold mt-4">Outcomes</h3>
              <ul className="list-disc ml-6">
                  <li>Implemented a Convolutional Neural Network that classifed skin lesions at 55% accuracy, ROC AUC of 80%. </li>
                  <li>Improved the model through Hyperparameter Optimization (HPO), pushing accuracy to 70%. </li>
                  <li>Fine-tuned MobileNet architecture to make a transfer learning model. </li>
                  <li>Wrote code to deploy the model on a simple webapp to allow upload and diagnosis with Flask. </li>
                </ul>
              <h3 className="font-semibold mt-4">Technologies Used</h3>
              <div className="mt-3 flex flex-wrap gap-1.5">
                <span className="px-2 py-1 text-s rounded-full bg-gray-100 text-gray-600">
...
`}
              ...
              <br></br>
              <ul className="list-disc ml-6">
                  <li>Learned about activation functions, and the different types of layers: Convolutional Layers, Pooling Layers, and Fully Connected Layers.</li>
...
def predict():
    ...
    try:
        ...
        return jsonify({'error': str(e)}), 500`}
              ...
              <br></br>
              <ul className="list-disc ml-6">
                  <li>Simple API route to read and preprocess the uploaded image, and return the model's prediction. </li>
              </ul>
          </section>
          <section>
            <h2 className="font-bold mt-4 text-xl">Transfer Learning Model: </h2>
            <SyntaxHighlighter
          language="python"
          style={solarizedlight} // You can change this to any Prism.js theme
          customStyle={{
  ...
  return transfer_model`}
          ...
          <h2 className="font-bold mt-4 text-xl">Full code: {" "}
            <a
